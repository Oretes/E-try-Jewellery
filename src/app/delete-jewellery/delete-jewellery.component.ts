...
@Component({
  selector: 'app-delete-jewellery',
  templateUrl: './delete-jewellery.component.html',
  styleUrls: ['./delete-jewellery.component.css']
})
export class DeleteJewelleryComponent implements OnInit {
